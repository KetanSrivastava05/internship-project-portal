...
const ExternalMentorRequests = () => {
    ...
    const fetchRequests = async () => {
        try {
            const { data } = await api.get('/external-mentor/requests');
            setRequests(data);
        } catch (error) {
            console.error(error);
    ...
    const handleAction = async (requestId, status) => {
        try {
            await api.put(`/external-mentor/requests/${requestId}`, { status });
...
export default ExternalMentorRequests;
